...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<User> selectByPrimaryKeyList(List<String> ids) {
    ...
    public Page<User> selectByRecordForPage(User record, int pageNo, int pageSize, String orderByClause) {
        ...
        if (record.getGendor() != null) {
            criteria.andEqualTo("gendor",record.getGendor());
        }
    ...
    @Override
    public Page<User> selectByParamsForPage(Long universityId,Short userType,Short gendor,String state, int pageNo, int pageSize, String orderByClause) {
        Example example = new Example(User.class);
        Example.Criteria criteria = example.createCriteria();
        ...
        if (gendor != null) {
             criteria.andEqualTo("gendor",gendor);
        }
        if (state != null) {
    ...
    @Override
    public List<User> selectByParamsForList(Long universityId,Short userType,Short gendor,String state) {
        Example example = new Example(User.class);
        Example.Criteria criteria = example.createCriteria();
