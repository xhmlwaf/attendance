...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public PageInfo<StudentKeysInfo> getStudentForPageByClassIdsAndBuildingId(List<Long> classIds, Long buildingId, String nameOrCode, Integer pageNo, Integer pageSize) {
        PageHelper.startPage(pageNo, pageSize);
        List<User> userList = userMapper.getStudentForListByClassIdsAndBuildingId(classIds, buildingId, nameOrCode);
        PageInfo pageInfo = new PageInfo(userList);
        return pageInfo;
    }
