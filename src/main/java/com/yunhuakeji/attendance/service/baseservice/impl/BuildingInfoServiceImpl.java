...
public class BuildingInfoServiceImpl implements BuildingInfoService {
  ...
  @Override
  public Page<BuildingInfo> selectByRecordForPage(BuildingInfo record, int pageNo, int pageSize,
  ...
  @Override
  public Page<BuildingInfo> selectByParamsForPage(Byte type, Long universityId, String state,
